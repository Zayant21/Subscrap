# Generated by Django 3.2.9 on 2021-12-20 10:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtype', models.CharField(blank=True, choices=[('Music', 'Music'), ('Video', 'Video'), ('Gaming', 'Gaming'), ('News', 'News'), ('Lifestyle', 'Lifestyle'), ('Access', 'Online Access')], max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtype', models.CharField(blank=True, choices=[('Music', 'Music'), ('Video', 'Video'), ('Gaming', 'Gaming'), ('News', 'News'), ('Lifestyle', 'Lifestyle'), ('Online Access', 'Online Access')], max_length=50)),
                ('image', models.ImageField(default='images/logoemblem.png', upload_to='images')),
                ('website', models.URLField(default='https://subscrap.herokuapp.com/', max_length=250)),
                ('startDate', models.DateField(default=datetime.datetime(2021, 12, 20, 10, 5, 11, 176863))),
